...
export default function RepeatBehavior({ id, editMode }) {
    ...
    <View style={styles.container}>
      {isLoading ? (
        ...
        <Fragment>
          ...
          >
            <RepeatItem title="Does not repeat" selected={title} setSelected={setTitle} setExpanded={setExpanded} />
            <RepeatItem title="Daily" selected={title} setSelected={setTitle} setExpanded={setExpanded} />
            <RepeatItem
